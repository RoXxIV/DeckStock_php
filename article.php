...
<html lang="en">
  ...
  <body id="myArticle">
    ...
    <main class="container">
      ...
      <a href="index.html"><i class="fas fa-arrow-left"></i> retour a l'accueil</a>
        ...
        <section id="moreArticle">
          ...
          <div class="row justify-content-center">
            <div class="col-6 col-md-3">
              <img class="img-fluid" src="img/planches/santaScreamingPurplr.jpg" alt="">
            </div>
            <div class="col-6 col-md-3">
              <img class="img-fluid" src="img/planches/santaScreamingRed.jpg" alt="">
            </div>
            <div class="col-6 col-md-3">
              <img class="img-fluid" src="img/planches/classicdot1.jpg" alt="">
            </div>
            <div class="col-6 col-md-3">
              <img class="img-fluid" src="img/planches/classicdot2.jpg" alt="">
            </div>
          </div>
        </section>
     </main>
